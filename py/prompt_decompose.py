...
def make_followup_prompt(task):
    return f'Using the same approach, decompose the task "{task}"'

info = '''Decompose the current task into the smallest possible number of smaller subtasks (usually two or three).
